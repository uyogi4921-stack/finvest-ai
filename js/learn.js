...
window.QUIZ_BANK = [
  // Foundations / basics
  { cat:'basics', q:'What do the green B and red S buttons on a stock card do?', correct:'Open a Buy or Sell order', wrong:['Bookmark the stock','Show the company news'], why:'B opens a Buy order, S opens a Sell order for that stock.', wrongWhy:{'Bookmark the stock':'bookmarking is the watchlist star, not the B/S buttons.','Show the company news':'news lives in the feed and stock detail, not these buttons.'} },
  { cat:'basics', q:'Invested ₹10,000, portfolio now ₹11,500 — your gain is?', correct:'₹1,500 (15%)', wrong:['₹1,000 (10%)','₹500 (5%)'], why:'11,500 − 10,000 = ₹1,500, and 1,500 ÷ 10,000 = 15%.', wrongWhy:{'₹1,000 (10%)':'that would need a value of ₹11,000, not ₹11,500.','₹500 (5%)':'that would need a value of ₹10,500, not ₹11,500.'} },
  { cat:'basics', q:'What does "Total Portfolio Value" represent?', correct:'All holdings valued at current prices', wrong:['Only the cash in your wallet','The money you originally invested'], why:'It is every holding marked to its live price — not your cash or your cost.', wrongWhy:{'Only the cash in your wallet':'that is your wallet balance, a separate number.','The money you originally invested':'that is your cost basis (Invested), not current value.'} },
  { cat:'basics', q:'On a stock card, what does the percentage under the price show?', correct:'How much the price moved today', wrong:['The dividend yield','The broker commission'], why:'That % is the day change — how far the price moved from the previous close.', wrongWhy:{'The dividend yield':'yield is annual dividend ÷ price, shown elsewhere.','The broker commission':'this practice app charges no commission.'} },
  { cat:'basics', q:'Short-term red (losses) in a portfolio usually means?', correct:'Normal market movement — stay patient', wrong:['You must sell immediately','The app has a bug'], why:'Prices swing daily; short-term red is normal and not a reason to panic-sell.', wrongWhy:{'You must sell immediately':'panic-selling locks in losses — the classic beginner mistake.','The app has a bug':'live prices move every day; red is real market data.'} },
  // Stocks & markets
  { cat:'stocks', q:'You own 10 of 1,000 total shares. What % do you own?', correct:'1%', wrong:['0.1%','10%'], why:'10 ÷ 1,000 = 0.01 = 1%.', wrongWhy:{'0.1%':'that would be 1 share out of 1,000.','10%':'that would be 100 shares out of 1,000.'} },
  { cat:'stocks', q:'Which index tracks India’s top 50 NSE companies?', correct:'NIFTY 50', wrong:['SENSEX','BANK NIFTY'], why:'NIFTY 50 is the NSE benchmark of 50 large-caps; SENSEX is BSE’s 30.', wrongWhy:{'SENSEX':'SENSEX tracks 30 companies on the BSE, not 50 on the NSE.','BANK NIFTY':'that is only banking stocks, not the top 50 overall.'} },
  { cat:'stocks', q:'A high P/E ratio versus peers generally signals the stock is?', correct:'Expensive / potentially overvalued', wrong:['A guaranteed bargain','Paying high dividends'], why:'A high P/E means you pay more per rupee of earnings — pricier, unless growth justifies it.', wrongWhy:{'A guaranteed bargain':'high P/E is the opposite — you pay more per unit of earnings.','Paying high dividends':'P/E says nothing about dividends; that is the yield.'} },
  { cat:'stocks', q:'Buying a share makes you a?', correct:'Part-owner of the company', wrong:['Lender to the company','Employee of the company'], why:'Shares are ownership; lending money to a company is a bond.', wrongWhy:{'Lender to the company':'lending is a bond, which pays interest — not ownership.','Employee of the company':'owning shares gives no job or salary.'} },
  { cat:'stocks', q:'Two main ways a stock makes you money are capital appreciation and?', correct:'Dividends', wrong:['Interest coupons','Loyalty points'], why:'Stocks pay you via price gains (appreciation) and dividends; coupons are for bonds.', wrongWhy:{'Interest coupons':'coupons are paid by bonds, not stocks.','Loyalty points':'stocks pay cash dividends, not points.'} },
  { cat:'stocks', q:'Market capitalisation is calculated as?', correct:'Share price × total shares', wrong:['Price ÷ earnings','Revenue − costs'], why:'Market cap = price × shares outstanding (Price ÷ earnings is the P/E).', wrongWhy:{'Price ÷ earnings':'that formula is the P/E ratio, not market cap.','Revenue − costs':'that is profit, not company size.'} },
  // Risk & strategy
  { cat:'risk', q:'Which risk affects ALL stocks at once?', correct:'Market risk', wrong:['Company risk','Liquidity risk'], why:'Market (systematic) risk hits the whole market — e.g. a crash; company risk is specific to one firm.', wrongWhy:{'Company risk':'that hits one firm only — diversification reduces it.','Liquidity risk':'that is about how easily you can sell, not a market-wide drop.'} },
  { cat:'risk', q:'The most proven way to reduce risk for retail investors is?', correct:'Diversification across sectors', wrong:['Putting everything in one hot stock','Borrowing to invest more'], why:'Spreading across sectors means one company’s fall doesn’t sink your whole portfolio.', wrongWhy:{'Putting everything in one hot stock':'concentration raises risk — the opposite of diversifying.','Borrowing to invest more':'leverage amplifies losses, increasing risk.'} },
  { cat:'risk', q:'Higher potential returns usually come with?', correct:'Higher risk', wrong:['Zero risk','Guaranteed profit'], why:'Risk and reward move together — higher possible returns carry higher risk of loss.', wrongWhy:{'Zero risk':'no real investment offers high return at zero risk.','Guaranteed profit':'guaranteed high returns are a hallmark of scams.'} },
  { cat:'risk', q:'Inflation risk means?', correct:'Returns may not beat rising prices', wrong:['Your broker raises fees','The market closes early'], why:'If your return is below inflation, your money loses real purchasing power.', wrongWhy:{'Your broker raises fees':'that is a cost issue, not inflation risk.','The market closes early':'trading hours have nothing to do with inflation.'} },
  { cat:'strategy', q:'A SIP (Systematic Investment Plan) means you?', correct:'Invest a fixed amount at regular intervals', wrong:['Sell everything each month','Trade options weekly'], why:'A SIP invests a set amount on a schedule (e.g. monthly), averaging your cost over time.', wrongWhy:{'Sell everything each month':'a SIP buys steadily — it never forces selling.','Trade options weekly':'SIPs are simple recurring buys, not options trading.'} },
  { cat:'strategy', q:'Rupee/dollar-cost averaging automatically buys more units when prices?', correct:'Fall', wrong:['Rise','Stay flat'], why:'A fixed amount buys more units when prices are low and fewer when high — lowering average cost.', wrongWhy:{'Rise':'when prices rise, a fixed amount buys fewer units.','Stay flat':'flat prices buy a constant number of units, not more.'} },
  { cat:'strategy', q:'Long-term investing tends to win because of?', correct:'Compounding over time', wrong:['Daily market timing','Frequent trading fees'], why:'Compounding lets returns earn their own returns — it snowballs the longer you stay invested.', wrongWhy:{'Daily market timing':'timing daily is unreliable and usually hurts returns.','Frequent trading fees':'fees drag returns down, not up.'} },
  { cat:'strategy', q:'Checking prices every hour usually leads to?', correct:'Emotional panic decisions', wrong:['Better returns','Lower taxes'], why:'Obsessive checking fuels fear/greed and impulsive trades — think in years, not hours.', wrongWhy:{'Better returns':'over-monitoring tends to lower returns via panic trades.','Lower taxes':'how often you look has no effect on taxes.'} },
  // Advanced
  { cat:'advanced', q:'An ETF is best described as?', correct:'A basket of assets traded like a stock', wrong:['A single company’s bond','A type of savings account'], why:'An ETF holds many securities in one basket and trades on the exchange like a share.', wrongWhy:{'A single company’s bond':'an ETF holds many assets, not one company’s debt.','A type of savings account':'ETFs trade on an exchange and can lose value — not a deposit.'} },
  { cat:'advanced', q:'Futures and options are mainly?', correct:'High-risk instruments, not for beginners', wrong:['Safe guaranteed-return products','Government savings bonds'], why:'Derivatives use leverage and can lose money fast — they’re not beginner products.', wrongWhy:{'Safe guaranteed-return products':'derivatives are leveraged and can lose money fast.','Government savings bonds':'those are low-risk debt, the opposite of derivatives.'} },
  { cat:'advanced', q:'Crypto differs from stocks mainly because it?', correct:'Trades 24/7 and is highly volatile', wrong:['Pays fixed dividends','Is risk-free'], why:'Crypto trades around the clock with big swings, and pays no dividend or fixed return.', wrongWhy:{'Pays fixed dividends':'crypto pays no dividend; value comes from demand.','Is risk-free':'crypto is among the most volatile assets there is.'} },
  ...
  { cat:'basics', q:'“Market cap” of a company is?', correct:'Share price × number of shares', wrong:['Yearly profit','Total debt'], why:'Market cap = price × shares outstanding.', wrongWhy:{'Yearly profit':'profit is earnings, not company size.','Total debt':'debt is what a company owes, not its market value.'} },
  { cat:'stocks', q:'A dividend is?', correct:'A share of profits paid to shareholders', wrong:['A loan repayment','A trading fee'], why:'Companies distribute part of profits as dividends.', wrongWhy:{'A loan repayment':'that describes paying back a bond, not a dividend.','A trading fee':'fees go to brokers, dividends come from the company.'} },
  { cat:'risk', q:'“Volatility” measures?', correct:'How much a price swings up and down', wrong:['Total dividends paid','The broker’s fee'], why:'Higher volatility = larger price swings = more risk.', wrongWhy:{'Total dividends paid':'that is income, not price movement.','The broker’s fee':'fees are a fixed cost, unrelated to swings.'} },
  { cat:'strategy', q:'Compounding works best with?', correct:'Time — staying invested longer', wrong:['Frequent withdrawals','Daily trading'], why:'Returns earning returns snowball over long periods.', wrongWhy:{'Frequent withdrawals':'taking money out stops it from compounding.','Daily trading':'churning racks up fees and breaks the snowball.'} },

  // ── Researched additions ──
  { cat:'basics', q:'The main reason to invest instead of just saving is to?', correct:'Beat inflation and grow wealth', wrong:['Avoid all risk','Keep cash instantly available'], why:'Idle cash loses value to inflation; investing aims to outgrow it.', wrongWhy:{'Avoid all risk':'investing adds risk — saving is what avoids it.','Keep cash instantly available':'that is what a savings account is for, not investing.'} },
  { cat:'basics', q:'By the Rule of 72, money at 12% return roughly doubles in?', correct:'About 6 years', wrong:['About 2 years','About 20 years'], why:'72 ÷ 12 ≈ 6 years to double.', wrongWhy:{'About 2 years':'that would need a ~36% annual return.','About 20 years':'72 ÷ 20 is under 4% — far below 12%.'} },
  ...
  { cat:'stocks', q:'A bond represents?', correct:'Lending money for fixed interest', wrong:['Ownership of the company','A type of dividend'], why:'Bonds are loans; stocks are ownership.', wrongWhy:{'Ownership of the company':'that is a share/stock, not a bond.','A type of dividend':'a dividend is a profit payout to shareholders, not a loan.'} },
  { cat:'stocks', q:'A key advantage of an ETF is?', correct:'Instant diversification at low cost', wrong:['Guaranteed returns','No risk at all'], why:'One ETF holds many securities cheaply.', wrongWhy:{'Guaranteed returns':'ETFs rise and fall with the market — nothing guaranteed.','No risk at all':'ETFs still carry market risk, just spread out.'} },
  ...
  { cat:'risk', q:'Before investing, you should first build?', correct:'An emergency fund of 3–6 months expenses', wrong:['A portfolio of risky stocks','A margin trading account'], why:'A cash buffer prevents selling investments at a loss in a crisis.', wrongWhy:{'A portfolio of risky stocks':'without a cash buffer, a crisis forces selling at a loss.','A margin trading account':'borrowing to trade before you have savings is very risky.'} },
  { cat:'risk', q:'“Real return” means?', correct:'Return after subtracting inflation', wrong:['Return before any fees','The highest possible return'], why:'Real return = nominal return − inflation.', wrongWhy:{'Return before any fees':'that is gross return, ignoring inflation.','The highest possible return':'real return is about purchasing power, not a maximum.'} },
  { cat:'risk', q:'A rough guide for stock allocation by age is?', correct:'About 110 minus your age, in %', wrong:['Always 100% stocks','Always 50/50'], why:'Younger investors can hold more stocks; shift to bonds nearer goals.', wrongWhy:{'Always 100% stocks':'too aggressive as you near goals and need stability.','Always 50/50':'ignores age — a 20-year-old can usually hold more stocks.'} },
  ...
  { cat:'strategy', q:'A fund’s expense ratio is?', correct:'The annual fee charged as a % of your money', wrong:['Its yearly return','A one-time entry charge'], why:'Even small fees compound against you over decades.', wrongWhy:{'Its yearly return':'return is what you earn; the expense ratio is what you pay.','A one-time entry charge':'the expense ratio is charged every year, not once.'} },
  { cat:'strategy', q:'Index funds aim to?', correct:'Track an index at low cost', wrong:['Beat the market by trading fast','Avoid the market entirely'], why:'They mirror an index cheaply and beat most active funds long-term.', wrongWhy:{'Beat the market by trading fast':'that is active trading — index funds just match the index.','Avoid the market entirely':'index funds are fully invested in the market.'} },
  { cat:'advanced', q:'Dividend yield is calculated as?', correct:'Annual dividend ÷ share price', wrong:['Share price ÷ earnings','Profit ÷ total shares'], why:'Yield = annual dividend / price.', wrongWhy:{'Share price ÷ earnings':'that is the P/E ratio, not yield.','Profit ÷ total shares':'that is earnings per share (EPS).'} },
  { cat:'advanced', q:'Panic-selling at the bottom is an example of?', correct:'A behavioral bias (loss aversion)', wrong:['Smart risk management','Diversification'], why:'Emotion-driven selling locks in losses — a classic behavioral trap.', wrongWhy:{'Smart risk management':'real risk management is planned, not panic-driven.','Diversification':'that is spreading holdings, unrelated to panic-selling.'} },
  ...
  // ── US markets, crypto & charts ──
  { cat:'stocks', q:'The main US benchmark of 500 large companies is the?', correct:'S&P 500', wrong:['Nasdaq 100','Dow Jones'], why:'The S&P 500 tracks 500 large US companies; the Dow is just 30 and the Nasdaq 100 is tech-heavy.', wrongWhy:{'Nasdaq 100':'that is 100 mostly-tech names, not 500 broad ones.','Dow Jones':'the Dow tracks just 30 companies.'} },
  { cat:'stocks', q:'Who regulates the US stock market?', correct:'The SEC', wrong:['The SEBI','The RBI'], why:'The SEC regulates US markets; SEBI and RBI are Indian regulators.', wrongWhy:{'The SEBI':'SEBI is India’s market regulator, not the US.','The RBI':'the RBI is India’s central bank.'} },
  ...
  { cat:'stocks', q:'On a candlestick, the thin line above/below the body is the?', correct:'Wick (high/low extremes)', wrong:['Dividend marker','Volume bar'], why:'The wick (shadow) shows the high and low; the body shows open-to-close.', wrongWhy:{'Dividend marker':'candlesticks show price, not dividends.','Volume bar':'volume is a separate bar below the chart.'} },
  { cat:'advanced', q:'An RSI reading above 70 is often described as?', correct:'Overbought', wrong:['Oversold','Guaranteed to rise'], why:'RSI > 70 = often "overbought", < 30 = "oversold" — hints at extremes, not certainties.', wrongWhy:{'Oversold':'oversold is RSI below 30 — the opposite end.','Guaranteed to rise':'RSI hints at extremes; it never guarantees direction.'} },
  ...
  { cat:'advanced', q:'Bitcoin and Ethereum differ in that Ethereum is mainly a?', correct:'Platform for smart contracts and apps', wrong:['Government currency','Fixed-income bond'], why:'Ethereum runs smart contracts/apps; Bitcoin is primarily digital money / store of value.', wrongWhy:{'Government currency':'no government issues ETH — it is decentralised.','Fixed-income bond':'crypto pays no fixed interest like a bond.'} },
